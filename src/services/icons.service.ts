...
import { faSearch, faSort, faGlasses, faHistory, faStar, faUserClock, faUserCheck, faExclamationTriangle, faChartBar, faFilePdf } from '@fortawesome/free-solid-svg-icons';
